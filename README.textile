...
This other method provides you with a mean to store a list of relations in one place. The class of your elements will be guessed from the attribute name, and elements will be stored with their ID.
...
- @:uniq => true@ allows your list to act like a group with only one instance of each element
...
em. Of course, this only works with non-polymorphic relations.
